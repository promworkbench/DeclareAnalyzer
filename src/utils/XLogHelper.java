...
public class XLogHelper {
	 ...
	 */
	public static void decorateElement(XAttributable element, String attributeName, XAttribute value, String extensionName) {
		if (element == null) {
			return;
		}
	 ...
	 * @param value the attribute value
	 */
	public static void decorateElement(XAttributable element, String attributeName, XAttribute value) {
	...
	/**
	 * This method returns the value of the attribute <tt>concept:name</tt> for
	 * the given attributable element, possibly concatenated to the
	 * <tt>lifecycle:transition</tt>.
	 * 
	 * @param activity the activtyi to analyze
	 * @return the complete activity name
	 */
	public static String getCompleteName(XAttributeMap activity) {
		String activityName = activity.get(XConceptExtension.KEY_NAME).toString();
		XAttribute eventType = activity.get(XLifecycleExtension.KEY_TRANSITION);
		if (eventType != null && !eventType.toString().isEmpty()) {
			activityName = activityName + "-" + eventType.toString();
		} else {
			activityName = activityName + "-complete";
		}
