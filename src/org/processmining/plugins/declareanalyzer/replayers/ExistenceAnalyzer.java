...
public class ExistenceAnalyzer implements DeclareReplayer{
	...
	public ExistenceAnalyzer(List<List<String>> dispositions){
	...
	//
	public Set<Integer> getBExistenceFulfillments(String traceId, String param1, String param2) {
		Set<Integer> output = new HashSet<Integer>();
	...
	//
		public Set<Integer> getBExistenceViolations(String traceId, String param1, String param2) {
			Set<Integer> output = new HashSet<Integer>();
			//int numberOfActivations = 0;
			if(activations.containsKey(traceId) && activations.get(traceId).containsKey(param1)){
				output.addAll(activations.get(traceId).get(param1));
