...
public class Existence2Analyzer implements DeclareReplayer{
	...
	public Existence2Analyzer(List<List<String>> dispositions){
	...
	//
		...
		//
		public Set<Integer> getBExistence2Fulfillments(String traceId, String param1, String param2) {
			Set<Integer> output = new HashSet<Integer>();
		...
		//
			public Set<Integer> getBExistence2Violations(String traceId, String param1, String param2) {
				Set<Integer> output = new HashSet<Integer>();
				//int numberOfActivations = 0;
				if(activations.containsKey(traceId) && activations.get(traceId).containsKey(param1)){
					output.addAll(activations.get(traceId).get(param1));
